    ...
    <div class="col-10">
      ...
      <table class="table">
        ...
        $sql = "SELECT t.id, 
                ...
                INNER JOIN exercicio AS e3 ON t.exercicio2 = e3.id
                INNER JOIN exercicio AS e4 ON t.exercicio1 = e4.id
                INNER JOIN exercicio AS e5 ON t.exercicio2 = e5.id
                INNER JOIN exercicio AS e6 ON t.exercicio2 = e6.id;";
